...
countries_to_extract = ['Colombia', 'Mongolia', 'China', 'Japan', 'Malaysia', 'Austria', 'Belgium', 'Bulgaria', 'Croatia', 'Republic of Cyprus', 'Czech Republic', 'Denmark', 'Estonia', 'Finland', 'France', 'Germany', 'Greece', 'Hungary', 'Ireland', 'Italy', 'Latvia', 'Lithuania', 'Luxembourg', 'Malta', 'Netherlands', 'Poland', 'Portugal', 'Romania', 'Slovakia', 'Slovenia', 'Spain', 'Sweden']
...
output_shapefile = '/Users/nicolashock/Documents/GitHub/green_finance_taxonomies/Polygons/greenCountries_Output'  # Replace '/path/to/output_folder/' with the actual path to the output folder.
